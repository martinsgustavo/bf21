...
public class PlanMealsControl {
    ...
    public boolean saveFoodToMeal(FoodPlan foodPlan, PlanDays planDays, PlanMeals object, Food food){

        Call<ResponseServer> call = apiInterface.saveFoodToMeal(foodPlan.get_idFoodPlan(), planDays.get_idPlanDay(), object.get_idPlanMeal(), food);
